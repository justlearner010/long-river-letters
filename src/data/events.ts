...
export const events: WorldEvent[] = [
  ...
  // c6 革命与民族国家
  { id: 'e148', year: 1804, title: '拿破仑称帝与海地独立', summary: '法国国内走向帝国，海地奴隶革命成功建立独立国家。', category: 'revolution', regions: ['欧洲', '拉美'], polityIds: ['france', 'haiti'], chapterId: 'c6', importance: 3, featured: true },
  ...
  { id: 'e169', year: 1913, title: '第二次巴尔干战争', summary: '巴尔干国家互斗，奥斯曼几乎退出欧洲，欧洲火药桶进一步点燃。', category: 'war', regions: ['欧洲'], polityIds: ['ottoman', 'greece', 'bulgaria', 'serbia'], chapterId: 'c7', importance: 2 },
  // c8 一战
  ...
  { id: 'e199', year: 1948, title: '以色列建国与柏林封锁', summary: '以色列宣布建国并随即爆发中东战争，苏联封锁柏林使冷战第一次直面对抗。', category: 'war', regions: ['西亚', '欧洲'], polityIds: ['usa', 'ussr', 'united-kingdom', 'israel', 'germany'], chapterId: 'c11', importance: 3, featured: true },
  ...
  { id: 'e201', year: 1950, title: '朝鲜战争爆发', summary: '朝鲜半岛战争使冷战在亚洲热战化，并固化东北亚分裂。', category: 'war', regions: ['东亚'], polityIds: ['usa', 'china-prc', 'ussr', 'south-korea', 'north-korea'], chapterId: 'c11', importance: 3, featured: true },
  { id: 'e202', year: 1955, title: '华约与万隆会议', summary: '苏联阵营成立华约，亚非国家在万隆提出和平共处与不结盟。', category: 'organization', regions: ['欧洲', '全球'], polityIds: ['ussr', 'usa', 'germany', 'poland', 'indonesia'], chapterId: 'c11', importance: 3, featured: true },
  { id: 'e203', year: 1956, title: '苏伊士危机与匈牙利事件', summary: '英法以入侵埃及受阻，苏联镇压匈牙利改革，去殖民化与冷战同时加剧。', category: 'war', regions: ['北非', '欧洲'], polityIds: ['united-kingdom', 'france', 'ussr', 'usa', 'egypt', 'hungary'], chapterId: 'c11', importance: 3, featured: true },
  { id: 'e204', year: 1962, title: '古巴导弹危机', summary: '苏联在古巴部署导弹，美苏在核战边缘对峙后达成妥协。', category: 'war', regions: ['拉美', '全球'], polityIds: ['usa', 'ussr', 'cuba'], chapterId: 'c11', importance: 3, featured: true },
  ...
  { id: 'e211', year: 1997, title: '香港回归与亚洲金融危机', summary: '香港主权移交中国，亚洲金融危机冲击泰国、韩国与印尼等经济体。', category: 'economy', regions: ['东亚', '东南亚'], polityIds: ['china-prc', 'united-kingdom', 'thailand', 'south-korea', 'indonesia'], chapterId: 'c12', importance: 3, featured: true },
